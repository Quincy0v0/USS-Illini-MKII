/**
 * @fileoverview
 * Defining the PlayerIndex class
 * @exports PlayerIndex
 * @todo More fractoring needed
 */
import React, { Component } from 'react';
import { NavLink } from 'react-router-dom';
import { Icon, Header, Statistic, Container, Divider, List, Image, Card, Tab } from 'semantic-ui-react';
...
import { division, divisionWhole, application_id } from '../../Common/utlity.js';
...
/**
 * PlayerIndex class that renders the detailed info for a player by
 *    making relevant api calls
 * @extends {Component}
 */
export default class PlayerIndex extends Component {
  ...
  /**
   * Making api calls to retrieve data of a player given an account_id
   * @param {*} account_id distinct numeric id for each player
   */
