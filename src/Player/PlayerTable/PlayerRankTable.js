...
/**
 * Local class PlayerShipTableBody for rendering mobile view of ship table (desktop)
 */
...
/**
 * Component PlayerRankTable renders the player's perfomance wrt. ship in rank matches
 * filters by rank seasons (desktop)
 */
